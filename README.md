# Esercitazione 3 di Visione Computazionale e Sistemi Cognitivi #
...
# 0. Setup
Copiate i vostri file `process_image.cpp` e `filter_image.cpp` nella cartella `./src/`, o utilizzate quelli di default.
